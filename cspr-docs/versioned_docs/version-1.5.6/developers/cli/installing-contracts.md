...
Once you call this command, it will return a deploy hash. You can use this hash to [verify](./sending-deploys.md#sending-a-deploy) successful execution of the deploy.
