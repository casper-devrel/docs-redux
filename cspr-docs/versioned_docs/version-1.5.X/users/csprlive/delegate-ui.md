...
5. Review the current [delegation fees](../../concepts/economics/staking/staking.md#delegation-fees) and ensure you have extra CSPR in your account's main purse apart from the amount you are delegating. Otherwise, the delegation might fail.
