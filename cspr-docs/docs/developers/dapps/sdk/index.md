...
The Casper platform uses a custom serialization format. To this end, we've established a [Serialization Standard](../../../concepts/serialization/index.md), which must be followed when building a Casper SDK.
